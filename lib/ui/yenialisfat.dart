...
class Yenialisfat extends StatefulWidget {
  Yenialisfat({this.cari});
  final Dtocarilist cari;
  @override
  _YenialisfatState createState() => _YenialisfatState();
}

class _YenialisfatState extends State<Yenialisfat> {
  int _currentStep = 0;
  ...
  Future cariara(String ar) async {
    lis = await APIServices.tedarara(ar);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white,
        elevation: 0,
        title: Text("Yeni Alış Fatura", style: Load.font(4)),
      ),
      body: LoadingOverlay(
                      ...
                      content: Column(
                        children: [
                          Align(
                              alignment: Alignment.centerLeft,
                              child: Text(
                                "Hangi tedarikçinizden alış yapıyorsunuz?",
                                style: Load.font(0),
                              )),
                          TextFormField(
                              onTap: () {
  ...
  void buildOnkaydet() async {
    ...
    print("lll");
    Get.find<Alisfatcontroller>().alisffattumekleyeni(Dtofatode(
        h[0],
        0,
        0,
        ca.cariId,
        ...
        h[1]));
    print("kkk");
    Get.find<Alisodenecekcontroller>().alisffodenekkleyeni(Dtofatode(
        h[0],
        0,
        0,
        ca.cariId,
        ...
        h[1]));
    print("mmm");
    Get.find<Tedarliscontroller>().tedarbakguncel(ca.cariId, -gentop);
    print("nnn");
    Get.find<Alisgecontroller>().alisffgeckkleyeni(Dtofatode(
        h[0],
        0,
        0,
        ca.cariId,
        ...
        h[1]));
    print("ccc");
    Get.find<Alisfatcontroller>().siradegistir(0);
    print("ddd");
    Get.find<Gunceldurumcontroller>().ayalisguncelle(gentop);
    print("eee");
    Get.find<Gdhaftacontroller>().haftaalisguncelle(gentop);
    print("fff");
    Get.find<Gdbuguncontroller>().gunalisguncelle(gentop);
    print("qqq");
    Navigator.of(context).pop();
  }
